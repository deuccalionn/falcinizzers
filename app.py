...
# --- KÜTÜPHANE KONTROLÜ ---
# Google Gemini yüklü mü diye bakar, hata vermesini engeller
try:
...
st.markdown("<p style='text-align:center; color:#ccc;'>Geçmişin sırları, geleceğin anahtarları...</p>", unsafe_allow_html=True)
